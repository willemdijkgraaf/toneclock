...
define(["require", "exports"], function(require, exports) {
    (function (ToneClock) {
        var Widget = (function () {
            ...
            Widget.prototype.getSheetTitle = function () {
                return this.mySheetTitle;
            };

            Widget.prototype.setSheetTitle = function (sTitle) {
                this.mySheetTitle = sTitle;
            };

            Widget.prototype.getSheetTransposition = function () {
                return this.mySheetTransposition;
            };

            Widget.prototype.setSheetTransposition = function (iTransposition) {
                this.mySheetTransposition = iTransposition % 7; // positive and negative -5 ... 5
            };

            Widget.prototype.getClocksHorizontal = function () {
                return this.myClocksHorizontal;
            };

            Widget.prototype.setClocksHorizontal = function (amount) {
                this.myClocksHorizontal = amount;
            };

            Widget.prototype.getClocksVertical = function () {
                return this.myClocksVertical;
            };

            Widget.prototype.setClocksVertical = function (amount) {
                this.myClocksVertical = amount;
            };

            Widget.prototype.getNoteNameStyle = function () {
                return this.myNoteNameStyle;
            };

            Widget.prototype.setNoteNameStyle = function (styleId) {
                // style id's can be 0 = 4ths, 1 = 5ths and 2 = seconds
                this.myNoteNameStyle = styleId;
            };

            Widget.prototype.getNoteNameAsPitchClass = function () {
                return this.myNoteNameAsPitchClass;
            };

            Widget.prototype.setNoteNameAsPitchClass = function (bPitchClass) {
                // true means note names as pitch classes
                this.myNoteNameAsPitchClass = bPitchClass;
            };

            Widget.prototype.getNoteNameFontSize = function () {
                return this.myNoteNameFontSize;
            };

            Widget.prototype.setNoteNameFontSize = function (pixels) {
                this.myNoteNameFontSize = pixels;
            };

            Widget.prototype.getNoteNameRotation = function () {
                return this.myNoteNameRotation;
            };

            Widget.prototype.setNoteNameRotation = function (rotation) {
                this.myNoteNameRotation = rotation;
            };

            Widget.prototype.getNoteNameFontName = function () {
                return this.myNoteNameFontName;
            };

            Widget.prototype.setNoteNameFontName = function (fontName) {
                this.myNoteNameFontName = fontName;
            };
            Widget.prototype.getNoteNameMargin = function () {
                return this.myNoteNameMargin;
            };

            Widget.prototype.setNoteNameDirection = function (bClockwise) {
                this.myNoteNameDirection = bClockwise;
            };

            Widget.prototype.getNoteNameDirection = function () {
                return this.myNoteNameDirection;
            };

            Widget.prototype.setNoteNameFlat = function (bFlat) {
                this.myNoteNameFlat = bFlat;
            };

            Widget.prototype.getNoteNameFlat = function () {
                return this.myNoteNameFlat;
            };

            Widget.prototype.setNoteNameMargin = function (pixels) {
                this.myNoteNameMargin = pixels;
            };

            Widget.prototype.getClockCanvasSize = function () {
                return this.myClockCanvasSize;
            };

            Widget.prototype.setClockCanvasSize = function (pixels) {
            ...
            Widget.prototype.setCanvasSize = function (horizontalClocks, verticalClocks) {
            ...
            Widget.prototype.cleanupArrayOfClocks = function (horizontalClocks, verticalClocks) {
            ...
            Widget.prototype.initializeClocks = function () {
                var i = 0;
            ...
            Widget.prototype.drawCanvas = function () {
            ...
            Widget.prototype._clearCanvas = function () {
                this.myContext.clearRect(0, 0, this.getCanvasWidth(), this.getCanvasHeight());
            };

            Widget.prototype.getCanvasWidth = function () {
                return this.myCanvasWidth;
            };

            Widget.prototype.setCanvasWidth = function (width) {
                this.myCanvasWidth = width;
            };

            Widget.prototype.getCanvasHeight = function () {
                return this.myCanvasHeight;
            };

            Widget.prototype.setCanvasHeight = function (height) {
                this.myCanvasHeight = height;
            };

            Widget.prototype.getClockSize = function () {
                return this.myClockSize;
            };

            Widget.prototype.setClockSize = function (pixels) {
                this.myClockSize = pixels;
            };

            Widget.prototype.setHourSize = function (pixels) {
                this.myHourSize = pixels;
            };

            Widget.prototype.getHourSize = function () {
                return (this.myHourSize);
            };

            Widget.prototype.createCanvasElement = function (parentElement) {
            ...
            Widget.prototype.drawClock = function (aClock) {
            ...
            Widget.prototype.drawHours = function (aClock) {
                for (var i = 12; i >= 1; i--) {
                    this.drawHour(aClock, i);
                }
            };

            Widget.prototype.drawHour = function (aClock, hour) {
                var x = 0;
                var y = 0;
                var radius = 0;
            ...
            Widget.prototype.drawCircle = function (x, y, radius, color, bFill) {
            ...
            Widget.prototype._getNoteNameIndex = function () {
            ...
            Widget.prototype.drawNoteNames = function (aClock) {
            ...
            Widget.prototype.drawNoteName = function (aClock, hour, iNoteNameIndex) {
                var x = 0;
                var y = 0;
                var radius = 0;
                var noteName = "";
            ...
            Widget.prototype._hourToNoteName = function (hour, iNoteNameIndex) {
                var noteName = "";
            ...
            Widget.prototype.addHarmony = function (toneClockId, harmonyId, sColor, bFill, aMidiNotes) {
            ...
            Widget.prototype.setClockProperties = function (toneClockId, sToneClockName, bDisplayRoot, iRootNoteNumber) {
            ...
            Widget.prototype.removeHarmoniesFromSheet = function () {
                var i = 0;
            ...
            Widget.prototype._removeHarmoniesFromClock = function (toneClockId) {
                var harmonies = [];
            ...
            Widget.prototype.hourToMidiNoteNumber = function (hour, styleId) {
                var noteNumber = 0;
                var rotation = this.getNoteNameRotation();
            ...
            Widget.prototype._drawSheetTitle = function () {
            ...
            Widget.prototype._drawClockName = function (aClock) {
            ...
            Widget.prototype._drawClockId = function (aClock) {
            ...
            Widget.prototype.drawHarmoniesOfClocks = function () {
                this.myToneClockId = 0;
            ...
            Widget.prototype._drawHarmonies = function (iClockIndex) {
            ...
            Widget.prototype._drawHarmony = function (aClock, aHarmony) {
                var toX = 0;
                var toY = 0;
                var endX = 0;
                var endY = 0;
            ...
            Widget.prototype._drawRoot = function (aClock) {
            ...
            Widget.prototype._transposeMidiNoteNumber = function (iNoteNumber, iTransposition) {
            ...
            Widget.prototype.drawMelody = function (aClock, aHarmony) {
                var toX = 0;
                var toY = 0;
                var endX = 0;
                var endY = 0;
            ...
            Widget.prototype.midiNoteNumberToHourIndex = function (aClock, midiNoteNumber) {
                var index = 0;
                for (var i = 0; i <= 12; i++) {
            ...
            Widget.prototype.noteNameFont = function () {
            ...
            Widget.prototype.writeText = function (x, y, text, sFontName, iFontSize, sTextAlign, sTextBaseline, color) {
            ...
            Widget.prototype.hourToX = function (hour, radius) {
            ...
            Widget.prototype.hourToY = function (hour, radius) {
