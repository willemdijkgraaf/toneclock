...
define(["require", "exports"], function (require, exports) {
    ...
    (function (ToneClock) {
        ...
        var Hour = (function () {
            ...
            Hour.prototype.toNoteName = function (hour, aNNPrefs) {
                var noteName = "";
            ...
            Hour.prototype.toHarmonicFunction = function (hour, rootAsMidiNoteNumber, aNNPrefs) {
                var harmonicFunction = "";
                var hourAsMidiNoteNumber = this.toMidiNoteNumber(hour, aNNPrefs);
                var index;
                index = ((hourAsMidiNoteNumber + 12) - rootAsMidiNoteNumber) % 12;
                return this.arrHarmonicFunctions[index];
            };
            // calculate vertical index
            Hour.prototype.getNoteNameIndexY = function (noteNameAs, noteNameInterval, noteNameAccidentals) {
            ...
            Hour.prototype.getNoteNameIndexX = function (hour, noteNameRotation, noteNameDirection) {
            ...
            Hour.prototype.toMidiNoteNumber = function (hour, aNNPrefs) {
                var noteNumber = 0;
